...
#
#	Adapted for Harestua - Glenn Persson, 2018
#
#	updated;
...
class HDFsave(hdfBaseRetDat.HDFbaseRetDat,hdfInitData.HDFinitData):
   ...
   def glblAttrbs(self,fDOI,idate,fdate):
      ...
      dataStr['PI_NAME']                 = 'Mellqvist;Johan'
      dataStr['PI_AFFILIATION']          = 'Chalmers University of Technology;CTH'
      dataStr['PI_ADDRESS']              = 'Department of Space, Earth and Environment;SE-41296 Gothenburg;SWEDEN'
      dataStr['PI_EMAIL']                = 'johan.mellqvist@chalmers.se'
      dataStr['DO_NAME']                 = 'Mellqvist;Johan'
      dataStr['DO_AFFILIATION']          = 'Chalmers University of Technology;CTH'
      dataStr['DO_ADDRESS']              = 'Department of Space, Earth and Environment;SE-41296 Gothenburg;SWEDEN'
      dataStr['DO_EMAIL']                = 'johan.mellqvist@chalmers.se'
      dataStr['DS_NAME']                 = 'Persson;Glenn'
      dataStr['DS_AFFILIATION']          = 'Chalmers University of Technology;CTH'
      dataStr['DS_ADDRESS']              = 'Department of Space, Earth and Environment;SE-41296 Gothenburg;SWEDEN'
      dataStr['DS_EMAIL']                = 'glenn.persson@chalmers.se'
      dataStr['DATA_DESCRIPTION']        = 'FTIR vmr vertical profile data at Harestua, Norway'
      dataStr['DATA_DISCIPLINE']         = 'ATMOSPHERIC.PHYSICS;REMOTE.SENSING;GROUNDBASED'
      dataStr['DATA_GROUP']              = 'EXPERIMENTAL;PROFILE.STATIONARY'
      dataStr['DATA_LOCATION']           = 'HARESTUA'
      ...
      dataStr['DATA_QUALITY']            = 'HBR cell measurements analysed with Linefit v9. about once per month'
      dataStr['DATA_CAVEATS']            = 'None'
      dataStr['DATA_RULES_OF_USE']       = 'Contact Mellqvist;Johan'
      dataStr['DATA_ACKNOWLEDGEMENT']    = 'EU projects UFTIR (with HYMN during 2008 and 2009), and Swedish EPA'
      dataStr['FILE_DOI']                = ' '
