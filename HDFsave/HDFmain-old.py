...
def main():
    ...
    idlFname       = '/data1/ebaumer/tab/co/errtest.sav'             # This is path and name of the IDL save file we use to store the data
    outDir         = '/data1/ebaumer/tab/co/ErrTest/'                # This is the directory where the HDF file will be written to
