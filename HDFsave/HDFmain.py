...
def main():
    ...
    # For IDL interface
    #------------------
    idlFname       = '/data1/ebaumer/'+loc1.lower()+'/'+gasName.lower()+'/mlo_clono2_Current_WP_sf0.sav'  # This is path and name of the IDL save file we use to store the data
    #outDir         = '/data1/ebaumer/'+loc1.lower()+'/'+gasName.lower()+'/HDFfiles/'      # This is the directory where the HDF file will be written to                                                  # This is the directory where the HDF file will be written to
    outDir         = '/data/Archive/'+loc1.upper()+'/2016/'+gasName.lower()+'/' 
