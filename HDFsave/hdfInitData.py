...
class HDFinitData(object):
    ...
    def initPy(self,dataDir,ctlF,spcDBfile,statLyrFile,iyear,imonth,iday,fyear,fmonth,fday,
               mxRMS=1.0,mxSZA=80.0,rmsFlg=True,tcFlg=True,pcFlg=True,cnvFlg=True,szaFlg=False, validFlg=False):
        ...
        # Filter data
        #------------
        pyData.fltrHDFdata(maxRMS=mxRMS, maxSZA=mxSZA, rmsF=rmsFlg, tcF=tcFlg, pcF=pcFlg, cnvF=cnvFlg, szaF=szaFlg, valF=validFlg)
