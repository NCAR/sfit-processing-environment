...
def main(argv):
    ...
    lstFile.info('ctl_File       = ' + inVars.inputs['ctlList'][ctl_ind][0]    )
    lstFile.info('FilterID       = ' + inVars.inputs['ctlList'][ctl_ind][1]    )
    lstFile.info('VersionName    = ' + inVars.inputs['ctlList'][ctl_ind][2]    )
