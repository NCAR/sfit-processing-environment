...
def main(argv):
    ...
    if logFile:
        ...
        hdlr1   = logging.FileHandler(log_fpath + datetime.datetime.now().strftime('%Y_%m_%d') + '.log',mode='w')
    ...
    if lstFlg:
        ...
        hdlr2   = logging.FileHandler(lst_fpath + datetime.datetime.now().strftime('%Y_%m_%d') + '.lst',mode='w')
