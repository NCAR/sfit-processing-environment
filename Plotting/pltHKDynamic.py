...
class RemoteHK():
    ...
    def __init__(self,Dir='', pdfFlg=False, DynamicFlg=False):
    ...
    def readHK(self, iyear='',iday='', imnth='', showID=False):
        ...
        ckFile(self.fname, exitFlg=True)
    ...
    def plt_HK(self, iyear='',iday='', imnth='', Groups= False, Groups_Lab= False, showID=False):
        ...
        if Groups:
            ...
            if self.pdfFlg: 
                pdfSave.savefig(fig1,dpi=600, bbox_inches='tight')
            else:
...
def main(argv):
    ...
    if DynamicFlg:
        while True:
            ...
            d.plt_HK(iyear=iyear,iday=iday, imnth=imnth, Groups=Groups , Groups_Lab=Groups_Lab )
        ...
        d.plt_HK(iyear=iyear,iday=iday, imnth=imnth, Groups=Groups , Groups_Lab=Groups_Lab, showID=True)
