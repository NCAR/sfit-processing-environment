...
\item \textit{Input:} Input NetCDF files are currently located at: \seqsplit{data1/ancillary\_data/fl0/eol/flab.YYYMMDD.cdf}
\item \textit{Output:} Output data is currently written to: \seqsplit{data1/ancillary\_data/fl0/eol/fl0\_met\_data\_YYYY.txt}
\end{itemize}
\end{itemize}
...
\item \textit{Output:} Appended spectral database file. Current location of spectral databases: \seqsplit{/data/Campaign/(MLO,TAB)/Spectral\_DB/}
\end{itemize}
\end{itemize}
...
\item \textit{Input:} The input NCEP nmc data is currently located at \seqsplit{/data/ancillary\_data/NCEP\_NMC/}
\item \textit{Output:} The re-formated NCEP nmc data is currently located at \seqsplit{/data/Campaign/(MLO,TAB,FL0)/NCEP\_nmc/}
\end{itemize}
\end{itemize}
...
\item \textit{Input:} The input NCEP nmc data is currently located at \seqsplit{/data/ancillary\_data/NCEP\_NMC/}. The input WACCM data is currently at \seqsplit{/data/Campaign/(MLO,TAB,FL0)/waccm/}
\item \textit{Output:} The profiles are stored with the bnr data in the daily directories \seqsplit{/data1/(mlo,tab,fl0)/}
\end{itemize}
\end{itemize}
...
\item \textit{Input:} The input ERA-Interim (GRIB) data is currently located at \seqsplit{/data1/ancillary\_data/ERAdata/}
\item \textit{Output:} The output ERA-Interim (NetCDF) data is currently located at \seqsplit{/data1/ancillary\_data/ERAdata/}
\end{itemize}
\end{itemize}
...
\item \textit{Input:} The input ERA-Interim (NetCDF) data is currently located at \seqsplit{/data1/ancillary\_data/ERAdata/}
...
\item \textit{Input:} The input NCEP re-analysis (NetCDF) data is currently located at \seqsplit{/data1/ancillary\_data/NCEPdata/}
\item \textit{Output:} The output water profiles are stored with the bnr data in the daily directories \seqsplit{/data1/(mlo,tab,fl0)}
\end{itemize}
\end{itemize}
...
\item \textit{Input:} The input water profiles are located with the bnr data in the daily directories \seqsplit{/data1/(mlo,tab,fl0)}
\item \textit{Output:} The output water profiles are stored with the bnr data in the daily directories \seqsplit{/data1/(mlo,tab,fl0)}
\end{itemize}
\end{itemize}
